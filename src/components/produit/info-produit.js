        ...
        <div class="divInfo-container">
            <div className='div-info-produit'>
                ...
                <div className='div-add-panier-herat'>
                    <button id="btn-panier"> <Link to="/">Ajouter au panier </Link>
                    </button>

                    {panier.filter(p => p.id_produit == id_prod).length <= 0 ?
                        <button id="btn-heart" onclick="addInPanier()">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-arrow-through-heart" viewBox="0 0 16 16">
            ...
            <div className='div-matiere-container'>
